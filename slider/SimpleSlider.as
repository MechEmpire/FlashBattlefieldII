...
{
	/**
	 * @author flashAnimationProgramming
	 * @version modified by shrekshao
	 * plus an alternate of the name of the variable and the textfield of the value
	 */
	...
	public class SimpleSlider extends Sprite
	{
		...
		private var _visible_name:Boolean = false;
		private var _visible_value:Boolean = false;
		
		private var _name_tf:TextField;
		private var _value_tf:TextField;
		...
		public function SimpleSlider(min:Number = 0, max:Number = 100, value:Number = 100, n:String = "", v_n:Boolean = true,v_v:Boolean=true )
		{
			_visible_name = v_n;
			_visible_value = v_v;
			_name = n;
		...
		private function init_textfield():void
		{
			if (_visible_name)
			{
				_name_tf = new TextField();
				_name_tf.defaultTextFormat = txtformat;
				_name_tf.height = 25;
				_name_tf.width = 30;
				_name_tf.textColor = 0xffffff;
				_name_tf.selectable = false;
				_name_tf.text = _name;
			...
			if (_visible_value)
			{
				_value_tf = new TextField();
				_value_tf.defaultTextFormat = txtformat;
				_value_tf.height = 25;
				_value_tf.width = 35;
				_value_tf.textColor = 0xffffff;
				_value_tf.selectable = false;
				_value_tf.text =String(int(_value));
				
				
				_value_tf.y = _height+5;
				addChild(_value_tf);
			}
		}
